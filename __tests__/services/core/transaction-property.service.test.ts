...
describe("TransactionPropertyService", () => {
    ...
    beforeEach(() => {
        ...
        service = new TransactionPropertyService(
            mockExcludedTransactionService,
        );
    });
    ...
    describe("isExcludedTransaction", () => {
        it("should call excludedTransactionService.isExcludedTransaction", async () => {
            mockExcludedTransactionService.isExcludedTransaction.mockResolvedValue(
                true,
            );
            ...
            expect(
                mockExcludedTransactionService.isExcludedTransaction,
            ).toHaveBeenCalledWith("test", "100.00");
