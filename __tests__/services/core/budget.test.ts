...
import { FireflyApiClient, FireflyApiError } from '@derekprovance/firefly-iii-sdk';
...
describe('BudgetService', () => {
  ...
  describe('getBudgets', () => {
    ...
    it('should throw error when API call fails', async () => {
      mockApiClient.get.mockRejectedValue(new FireflyApiError('Failed to fetch budgets'));
  ...
  describe('getBudgetExpenseInsights', () => {
    ...
    it('should throw error when API call fails', async () => {
      mockApiClient.get.mockRejectedValue(new FireflyApiError('Failed to get budget expense insights for month 3'));
  ...
  describe('getBudgetLimits', () => {
    ...
    it('should throw error when API call fails', async () => {
      mockApiClient.get.mockRejectedValue(new FireflyApiError('Failed to get budget limits for month 3'));
