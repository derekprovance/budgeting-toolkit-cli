...
describe("TransactionValidatorService", () => {
    ...
    describe("shouldProcessTransaction", () => {
        it("should return true for non-transfer transactions when processTransactionsWithCategories is true", () => {
            ...
            expect(mockPropertyService.isTransfer).toHaveBeenCalledWith(
                mockTransaction,
            );
        });
        ...
        it("should return true for non-transfer transactions without categories when processTransactionsWithCategories is false", () => {
            ...
            expect(mockPropertyService.hasACategory).toHaveBeenCalledWith(
                mockTransaction,
            );
        });
    ...
    describe("shouldSetBudget", () => {
        it("should return true when all conditions are met", async () => {
            ...
            const result = await service.shouldSetBudget(
                mockTransaction as TransactionSplit,
            );

            expect(result).toBe(true);
            expect(mockPropertyService.isBill).toHaveBeenCalledWith(
                mockTransaction,
            );
            expect(mockPropertyService.isDisposableIncome).toHaveBeenCalledWith(
                mockTransaction,
            );
            expect(
                mockPropertyService.isExcludedTransaction,
            ).toHaveBeenCalledWith(
                mockTransaction.description,
                mockTransaction.amount,
            );
            expect(mockPropertyService.isDeposit).toHaveBeenCalledWith(
                mockTransaction,
            );
        });
    ...
    describe("validateTransactionData", () => {
        ...
        it("should return true for valid transaction data", () => {
            const result = service.validateTransactionData(
                mockTransaction as TransactionSplit,
                mockAIResults,
            );
        ...
        it("should return false when transaction has no journal ID", () => {
            ...
            const result = service.validateTransactionData(
                invalidTransaction as TransactionSplit,
                mockAIResults,
            );
    ...
    describe("categoryOrBudgetChanged", () => {
        it("should return true when category has changed", () => {
            ...
            const result = service.categoryOrBudgetChanged(
                mockTransaction as TransactionSplit,
                category,
                budget,
            );
