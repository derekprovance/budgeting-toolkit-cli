...
describe("UnbudgetedExpenseService", () => {
    ...
    describe("calculateUnbudgetedExpenses", () => {
        ...
        it("should filter out transactions with budgets", async () => {
            ...
            mockTransactionPropertyService.isExcludedTransaction.mockResolvedValue(
                false,
            );
            mockTransactionPropertyService.isSupplementedByDisposable.mockReturnValue(
                false,
            );
        ...
        it("should include bills regardless of other criteria", async () => {
            ...
            mockTransactionPropertyService.isBill
                .mockReturnValueOnce(true)
                .mockReturnValueOnce(false);
        ...
        describe("error handling", () => {
            it("should handle API errors with proper context", async () => {
                ...
                await expect(
                    service.calculateUnbudgetedExpenses(4, 2024),
                ).rejects.toThrow(
        ...
        describe("bill edge cases", () => {
            it("should include bills even with disposable income tags", async () => {
                ...
                mockTransactionPropertyService.isTransfer.mockReturnValue(
                    false,
                );
                mockTransactionPropertyService.isExcludedTransaction.mockResolvedValue(
                    false,
                ...
                const result = await service.calculateUnbudgetedExpenses(
                    4,
                    2024,
                );
