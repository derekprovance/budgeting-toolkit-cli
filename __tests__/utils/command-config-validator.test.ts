...
describe('CommandConfigValidator', () => {
    ...
    describe('validateSplitCommand', () => {
        it('should not throw or produce output (no-op validation)', () => {
            const config: AppConfig = {
                api: {
                    firefly: {
                        url: 'http://localhost',
            ...
            expect(() => CommandConfigValidator.validateSplitCommand(config)).not.toThrow();
            expect(mockConsoleError).not.toHaveBeenCalled();
