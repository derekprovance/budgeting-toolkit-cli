...
describe("UpdateTransactionsCommand", () => {
  ...
  beforeEach(() => {
    ...
    mockDisplayService = {
      ...
      formatTransactionUpdates: jest.fn().mockReturnValue(["Updates text", 2]),
    ...
    jest.spyOn(UpdateTransactionDisplayService.prototype, 'formatProcessingHeader').mockImplementation(mockDisplayService.formatProcessingHeader);
    jest.spyOn(UpdateTransactionDisplayService.prototype, 'formatTagNotFound').mockImplementation(mockDisplayService.formatTagNotFound);
    jest.spyOn(UpdateTransactionDisplayService.prototype, 'formatEmptyTag').mockImplementation(mockDisplayService.formatEmptyTag);
    jest.spyOn(UpdateTransactionDisplayService.prototype, 'formatTransactionUpdates').mockImplementation(mockDisplayService.formatTransactionUpdates);
    jest.spyOn(UpdateTransactionDisplayService.prototype, 'formatSummary').mockImplementation(mockDisplayService.formatSummary);
    jest.spyOn(UpdateTransactionDisplayService.prototype, 'formatError').mockImplementation(mockDisplayService.formatError);
  ...
  describe("execute", () => {
    it("should handle tag not found", async () => {
      ...
      expect(mockDisplayService.formatProcessingHeader).toHaveBeenCalledWith(params.tag, params.updateMode, undefined);
    ...
    it("should handle successful updates", async () => {
      ...
      expect(mockDisplayService.formatProcessingHeader).toHaveBeenCalledWith(params.tag, params.updateMode, undefined);
      expect(mockDisplayService.formatTransactionUpdates).toHaveBeenCalledWith(results, params.updateMode, undefined);
      expect(mockDisplayService.formatSummary).toHaveBeenCalledWith(results, 2, undefined);
    });
    ...
    it("should handle dry run mode", async () => {
      ...
      expect(mockDisplayService.formatProcessingHeader).toHaveBeenCalledWith(params.tag, params.updateMode, true);
      expect(mockDisplayService.formatTransactionUpdates).toHaveBeenCalledWith(results, params.updateMode, true);
      expect(mockDisplayService.formatSummary).toHaveBeenCalledWith(results, 2, true);
    });
